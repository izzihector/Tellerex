odoo.define('odoo-s3-bucket.s3_image', function (require) {
"use strict";
/**
...
var import_button = Char.extend({
       template : "import_button",
        ...
        import_files : function(event){
            ...
            console.log('ghjk');
            var attachment_ids = self.fields.attachment_ids; // Get existing attachments
            var data64 = null;
            var values_list = [];
	...
	fieldRegistry.add('import_button',import_button);
});
