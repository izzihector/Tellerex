...
#     @api.multi
    ...
    def dir_atm_process_images(self, unsplashurls=None, **kwargs):
        print('\n path',os.getcwd(),type(os.getcwd()),os.getcwd()+'/COD')
        dir = os.listdir(os.getcwd()+'/COD')
        for folder_name in dir:
            folder = os.listdir(os.getcwd()+'/COD'+"/{0}".format(folder_name))
            for sub_folder_name in folder:
                ...
                for file_name in sub_folder:
                    with open(os.getcwd()+'/COD'+"/{0}/{1}/{2}".format(folder_name,sub_folder_name,file_name), "rb") as imageFile:
                        str = base64.b64encode(imageFile.read())
                        # print('\n\n photo', str[:10])
                        photo_0 = str
