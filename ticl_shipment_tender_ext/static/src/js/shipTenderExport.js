odoo.define('ticl_shipment_tender_ext.shipTenderExport', function (require) {
"use strict";
...
var TenderImport = Dialog.extend({
    ...
    init: function(parent, defaultExportFields) {
        var options = {
            ...
            buttons: [
                {text: _t("Import"), click: this.import_outbond_tender, classes: "btn-primary sb_control",disabled:true},
...
//        }
    ...
    import_outbond_tender: function(event) {
    	var self = this;
        ...
        fileReader.onload = function () {
          ...
          if (self.defaultExportFields[0] == 'tender'){
        	  rpc.query({
                  ...
                  method: 'shipment_tender_import_ext',
                  args: [{'file':data}],
              })
