...
class StockWarehouseEmail(models.Model):
	...
	name = fields.Char(string="Emails", copy=False)
...
class ShipmentNotification(models.Model):
    ...
    def warehouse_pending_shipment_notification(self, ids):
        ...
        for warehouse in warehouses:
            location = self.env['stock.location'].search([('warehouse_key', '=', warehouse.warehouse_key)])
            ...
            if shipments:
                ...
                for ship in shipments:
                    ...
                    worksheet.write(index, 8, ship.receiving_location_id.email or '', final_style)
                ...
                attach = {
                    ...
                    'datas': excel_file,
                    'store_fname': 'Warehouse Pending Report.xls',
